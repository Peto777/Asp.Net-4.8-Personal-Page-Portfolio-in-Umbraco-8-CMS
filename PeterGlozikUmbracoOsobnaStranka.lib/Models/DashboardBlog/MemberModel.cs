...
namespace PeterGlozikUmbracoOsobnaStranka.lib.Models.DashboardBlog
{
    ...
    public class OsobnaStrankaMemberDropDown : CmpDropDown
    {
        public OsobnaStrankaMemberDropDown()
        {
        }

        public static OsobnaStrankaMemberDropDown CreateCustomerUserListFromRepository(bool allowNull, string emptyText = "[ žiadny užívateľ ]", bool allowAll = false, string allText = "[ všetci užívatelia ]")
        {
            OsobnaStrankaMemberRepository memberRepository = new OsobnaStrankaMemberRepository();
            return OsobnaStrankaMemberDropDown.CreateCopyFrom(memberRepository.GetCustomerUsers(), allowNull, emptyText, allowAll, allText);
        }

        public static OsobnaStrankaMemberDropDown CreateCopyFrom(List<OsobnaStrankaMember> memberList, bool allowNull, string emptyText, bool allowAll, string allText)
        {
            OsobnaStrankaMemberDropDown ret = new OsobnaStrankaMemberDropDown();
            ...
            foreach (OsobnaStrankaMember memberItem in memberList)
            {
                OsobnaStrankaMemberModel memberModel = OsobnaStrankaMemberModel.CreateCopyFrom(memberItem);
