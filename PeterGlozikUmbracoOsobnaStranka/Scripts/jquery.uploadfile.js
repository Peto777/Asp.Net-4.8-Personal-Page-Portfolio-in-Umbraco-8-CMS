...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Pretiahnite s˙bory tu alebo kliknite na Nahraù</b></span>",
            uploadStr:"Nahraù",
            abortStr: "Zruöiù",
            cancelStr: "Zruöiù",
            deletelStr: "Odstr·niù",
            doneStr: "Hotovo",
            multiDragErrorStr: "Vian·sobn˝ Drag &amp; Drop nie je povolen˝.",
            extErrorStr: "nie je povolenÈ. PovolenÈ prÌpony: ",
            duplicateErrorStr: "nie je povolenÈ. S˙bor uû existuje.",
            sizeErrorStr: " nie je povolenÈ. Maxim·lna povolen· veækosù: ",
            uploadErrorStr: "Nahr·vanie nie je povolenÈ",
            maxFileCountErrorStr: " nie je povolenÈ. Maxim·lny povolen˝ poËet s˙borov:",
            downloadStr: "Stiahnuù",
            ...
            var options = {
                ...
                success: function (data, message, xhr) {
                    ...
                    if(s.returnType == "json" && $.type(data) == "object" && data.hasOwnProperty(s.customErrorKeyStr)) {
                        ...
                        if(s.showStatusAfterError) {
                            pd.progressDiv.hide();
                            pd.statusbar.append("<span class='" + s.errorClass + "'>CHYBA: " + msg + "</span>");
                        } else {
                            pd.statusbar.hide();
                            pd.statusbar.remove();
                        }
                ...
                error: function (xhr, status, errMsg) {
                    ...
                    if(xhr.statusText == "abort") //we aborted it
                    {
                        ...
                        if(s.showStatusAfterError) {
                            pd.progressDiv.hide();
                            pd.statusbar.append("<span class='" + s.errorClass + "'>CHYBA: " + errMsg + "</span>");
                        } else {
                            pd.statusbar.hide();
                            pd.statusbar.remove();
                        }
